...
{
    public interface IServicesUsingTemplatesOnDisk : IServices
    {
        ///<summary>
        ...
        InterviewResult GetInterview(IOnDiskTemplate template, TextReader answers, InterviewSettings settings, IEnumerable<string> markedVariables, string logRef);
        ...
        OnDiskAssembleDocumentResult AssembleDocument(IOnDiskTemplate template, TextReader answers, AssembleDocumentSettings settings, string logRef);
        ...
        ComponentInfo GetComponentInfo(IOnDiskTemplate template, bool includeDialogs, string logRef);
        ...
        void BuildSupportFiles(IOnDiskTemplate template, HDSupportFilesBuildFlags flags);
        ...
        void RemoveSupportFiles(IOnDiskTemplate template);
        ...
        Stream GetInterviewFile(IOnDiskTemplate template, string fileName, string fileType);        
    }
