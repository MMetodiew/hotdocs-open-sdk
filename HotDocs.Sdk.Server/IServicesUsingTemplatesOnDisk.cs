...
namespace HotDocs.Sdk.Server
{
    public interface IServicesUsingTemplatesOnDisk : IServices
    {
        ...
        InterviewResult GetInterview(ITemplateOnDisk template, TextReader answers, InterviewSettings settings, IEnumerable<string> markedVariables, string logRef);
        ...
        OnDiskAssembleDocumentResult AssembleDocument(ITemplateOnDisk template, TextReader answers, AssembleDocumentSettings settings, string logRef);
        ...
        ComponentInfo GetComponentInfo(ITemplateOnDisk template, bool includeDialogs, string logRef);
        ...
        void BuildSupportFiles(ITemplateOnDisk template, HDSupportFilesBuildFlags flags);
        ...
        void RemoveSupportFiles(ITemplateOnDisk template);
        ...
        Stream GetInterviewFile(ITemplateOnDisk template, string fileName, string fileType);        
    }
}