...
{
    public class OffDiskAssembleDocumentResult : AssembleDocumentResult
    {
        /// <summary>
        ...
        internal OffDiskAssembleDocumentResult(Document document, string answers, IEnumerable<ITemplate> pendingAssemblies, IEnumerable<string> unansweredVariables)
        {
            Document = document;
            if (answers != null)
                Answers = answers;
